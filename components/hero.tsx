...
import HeroImage from '@/public/images/pragmatika-dashboard.png'
        ...
        <div className="px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
              <div className="text-center pb-12 md:pb-16">
                ...
                The platform where anyone can become an <em className="italic relative inline-flex justify-center items-center text-zinc-900"> entrepreneur
                ...
                Pragmatik simplifies the journey of launching a digital business—from shaping your idea to validating the market and building something people truly want.
                </p>
                <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  <div>
                    <Link className="btn text-zinc-100 bg-zinc-900 hover:bg-zinc-800 w-full shadow-sm" href="/request-demo">Start Your Project</Link>
                  </div>
                </div>
              </div>
          </div>
